...
{       ranametal at users.sourceforge.net              }
{                                                       }
{*******************************************************}
...
{$ENDIF}
  ...
  //HMRS
  TAddPropertyEvent = procedure(Sender: TZPropList; Prop: TPropertyEditor;
...
{$ENDIF}
    ...
    // HMRS
    property OnAddProperty: TAddPropertyEvent read FOnAddProperty write FOnAddProperty;
