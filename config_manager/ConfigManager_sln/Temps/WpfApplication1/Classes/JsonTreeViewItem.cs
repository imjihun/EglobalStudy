...
namespace Manager_proj_4
{
	...
	class JsonButton : Button/*MahApps.Metro.Controls.WindowButtonCommands*/
	{
		public JsonButton()
		{
			this.Style = (Style)(App.Current.Resources["MetroButton"]);
	...
	class JsonToggleButton : ToggleButton
	{
		...
		{
			this.Style = (Style)(App.Current.Resources["MetroToggleButton"]);
			this.Content = "more..";
	...
	class JsonTextBox : TextBox
	{
		public JsonTextBox()
		{
			this.Style = (Style)(App.Current.Resources["MetroTextBox"]);
